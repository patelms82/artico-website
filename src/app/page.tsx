...
export default function Home() {
  return (
    <div className="bg-white relative overflow-hidden">
      {/* Background decorative elements (subtle grayscale) */}
          ...
          <div className="text-center mb-20">
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="/contact"
                className="group relative px-8 py-4 bg-black text-white font-semibold rounded-full shadow-2xl overflow-hidden transition-all duration-300"
              >
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Creative <span className="text-black">Expertise</span>
              </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              {skills.map((skill, index) => (
                <motion.div
                  ...
                  className="group relative p-6 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-black/20"
                >
                  ...
                  <div className="relative z-10">
                    <div className="w-8 h-8 bg-black rounded-lg mb-3 flex items-center justify-center">
